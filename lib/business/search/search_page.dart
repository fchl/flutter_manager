...
import 'package:flutter_manager/business/search/history/cpn_search_history.dart';
import 'package:flutter_manager/business/search/hot/cpn_search_hot_key.dart';
import 'package:flutter_manager/business/search/result/cpn_search_result.dart';
        ...
        GestureDetector(
            ...
            child: Container(
                ...
                child: Text(
                  "取消",
                  style: TextStyle(
                      color: ColorPalettes.instance.secondText, fontSize: 28.sp),
                ))),
      ]),
    );
  }

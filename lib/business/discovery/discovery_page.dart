...
import 'package:flutter_manager/business/discovery/cpn/cpn_discovery_video_player.dart';
    ...
    return GestureDetector(
      ...
      child: Column(
        children: [
          ...
          Text(value, style: TextStyle(color: Colors.white, fontSize: 28.sp))
        ],
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Text(item.joke?.content ?? "",
                style:
                    TextStyle(color: const Color(0xFFDDDDDD), fontSize: 26.sp)),
          ],
        ),
      ),
    );

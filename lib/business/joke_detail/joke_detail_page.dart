...
import 'package:flutter_manager/business/common/sheet/joke_comment_sheet.dart';
import 'package:flutter_manager/business/joke_detail/joke_detail_logic.dart';
...
class JokeDetailPage extends CpnNestedPage<JokeDetailLogic> {
  ...
  Widget _tabBar() {
    return TabBar(
      ...
      labelStyle: TextStyle(fontSize: 36.sp, fontWeight: FontWeight.bold),
      unselectedLabelStyle:
          TextStyle(fontSize: 32.sp, fontWeight: FontWeight.normal),
      //未选中时标签的颜色
      onTap: (int index) {

...
import 'package:flutter_manager/business/common/cpn/cpn_video_play.dart';
...
import 'package:flutter_manager/common/util/permisson_util.dart';
  ...
  Widget _inputText() {
    return Container(
      ...
      child: TextField(
        ...
        maxLines: 10,
        style:
            TextStyle(fontSize: 28.sp, color: ColorPalettes.instance.firstText),
        ...
        decoration: InputDecoration(
          ...
          counterText: "",
          hintStyle: TextStyle(
              fontSize: 28.sp, color: ColorPalettes.instance.thirdText),
        ),
        onChanged: (value) {

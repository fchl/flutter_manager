...
import 'package:flutter_manager/business/login/verifycode/verifycode_login_logic.dart';
import 'package:flutter_manager/common/cpn/app_bar.dart';
import 'package:flutter_manager/common/cpn/cpn_verify_code_input.dart';
import 'package:flutter_manager/common/cpn/cpn_view_state.dart';
import 'package:flutter_manager/common/ext/asset_ext.dart';
import 'package:flutter_manager/common/util/keyboard_util.dart';
...
class VerifyCodeLoginPage extends CpnViewState<VerifyCodeLoginLogic> {
    ...
    return Column(
      ...
      children: [
        ...
        Text("未注册的手机号验证后将自动注册",
            style: TextStyle(
                color: ColorPalettes.instance.thirdText, fontSize: 24.sp)),
          ...
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: TextStyle(
                    fontSize: 36.sp, color: ColorPalettes.instance.secondText),
              ),
              onChanged: (value) {
  ...
  Widget refreshVerifyCodeButton() {
    return Container(
        ...
        child: Text("重新获取",
            style: TextStyle(
                color: ColorPalettes.instance.secondText, fontSize: 24.sp)));
  }

...
import 'package:flutter_manager/business/user_center/experience/cpn/overview/experience_overview_logic.dart';
          ...
          child: Column(
            children: [
              Text(
                "我的等级",
                style: TextStyle(
                    color: Colors.white, fontSize: 28.sp, letterSpacing: 1.25),
              ),
    ...
    return Column(
      ...
      children: [
        Text(
          value,
          style:
              TextStyle(fontSize: 30.sp, color: ColorPalettes.instance.primary),
        ),

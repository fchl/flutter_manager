...
class CpnCommentItem extends StatelessWidget {
  ...
  Widget _commentItemBody(JokeComment item) {
    ...
    bottomChildren.add(Text(
      item.timeStr ?? "--",
      style: TextStyle(fontSize: 24.sp, color: ColorPalettes.instance.thirdText),
    ));
    bottomChildren.add(GestureDetector(
      ...
      child: Padding(
        ...
        child: Text(
          "回复",
          style: TextStyle(
              fontSize: 24.sp, color: ColorPalettes.instance.secondText),
        ),
      ),
    ));
      ...
      bottomChildren.add(GestureDetector(
        ...
        child: Padding(
          ...
          child: Text(
            "删除",
            style: TextStyle(
                fontSize: 24.sp, color: ColorPalettes.instance.primary),
          ),
        ),
      ));
    }
        ...
        child: Column(
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                  fontSize: 28.sp, color: ColorPalettes.instance.thirdIcon),
            ),
          ],
        ));
  }
